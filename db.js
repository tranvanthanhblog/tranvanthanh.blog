// db.js
// Tách trách nhiệm: DB + Storage + Auth helper functions.
// THAY THẾ firebaseConfig bên dưới bằng cấu hình của bạn
...
const DB = (function () {
  ...
  const ADMIN_EMAILS = ["tranduonglx2020@gmail.com"]; // <-- thêm email admin ở đây
  ...
  function onPosts(callback, order = "desc") {
    ...
    // For ordering by createdAt, use query
  ...
  function addAdminEmail(email) {
    ...
    // Note: this only modifies runtime array. For persistent list use a DB node for admins.
  }
